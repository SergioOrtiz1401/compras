...
<form method="post" id="fupForm">
    ...
    <div class="form-row">
        ...
        <div class="validation_imagen_perfil"></div>
    </div>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp<button type="submit" class="btn btn-primary registrar">Registrar</button> &nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <button type="submit" class="btn btn-primary nuevo_registro">Nuevo Registro</button>
